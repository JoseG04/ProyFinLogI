...
function main(){
    ...
    let juego = new Juego();
    let jugador1 = new Jugador("Jose", 50, altoCanvas/2 - 30, 4, 4, 20, 60, ["color", "red"]);
    let jugador2 = new Jugador("David", anchoCanvas - 70, altoCanvas/2 - 30, 4, 4, 20, 60, ["color", "blue"]);
